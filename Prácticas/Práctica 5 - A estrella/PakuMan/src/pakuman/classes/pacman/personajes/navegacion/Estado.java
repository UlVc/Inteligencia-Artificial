...
public class Estado {
	...
	public void calculaHeuristica(Estado meta) {
            // Distancia hasta el estado meta usando el método Manhattan. Básicamente se busca las diferencias horizontales y verticales.
            hn = Math.abs(meta.pasillo.renglon() - meta.pasillo.renglon()) + Math.abs(meta.pasillo.columna() - meta.pasillo.columna());
            hn = hn * 10;
	}
