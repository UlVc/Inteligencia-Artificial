...
public class Gatos extends PApplet {
    ...
    private int jugador1_ganadas = 0; // Cuantas veces el jugador 1 ha ganado.
    private int jugador2_ganadas = 0; // Cuantas veces el jugador 2 ha ganado.
    private int empates = 0; // Cuantas veces el jugador 2 ha ganado.
    ...
    public void draw() {
        try {
            ...
            if (modificaVentana) {
                ...
                System.out.println("> Jugador 1 ganadas: " + jugador1_ganadas);
                System.out.println("> Jugador 2 ganadas: " + jugador2_ganadas);
                if (profundidad == 9) // Imprimimos los empates. Solamente ocurren hasta el último nivel (el 9).
    ...
    protected void generaSiguienteNivel() {
        ...
        for (int i = 0; i < numGatos; i++) {
            ...
            if (sucesores != null) {
                ...
                if (profundidad > 4) // Contamos los ganadores en el nuevo nivel.
                    for (Gato g : sucesores)
                        if (g.hayGanador)
                            if (g.jugador1)
                                ...
                                jugador2_ganadas++;
                        else if (profundidad == 9) // Los empates solo ocurren en el último nivel.
                            empates++;
            }
        }
